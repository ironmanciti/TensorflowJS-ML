...
// //concatenate
// let a = tf.tensor1d([1, 2]);
// let b = tf.tensor1d([3, 4]);
// a.concat(b).print();  // or a.concat(b)
// //slicing
// let x = tf.tensor1d([1, 2, 3, 4]);
// x.slice([1], [2]).print();
// //slice[start, size]
// x = tf.tensor2d([1, 2, 3, 4, 5, 6, 7, 8, 9], [3, 3]);
// x.slice([1], [2]).print()
...
// tense3d.data().then((result) => console.log('promise - ' + result)); 
...
// async function run() {
//     const arr = await tf.data.array([1, 2, 3, 4])
//         .map(mapping)
//         .skip(2)
//         .take(2)
//         .toArray();
